...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Mohamed Taher, a creative frontend developer, crafting immersive and intuitive web experiences.",
  description:
...
export const ABOUT_CONTENT = {
  paragraphs: [
    ...
    "I specialize in using technologies like React, Typescript, and Tailwind CSS to create responsive and scalable interfaces. My focus is on writing clean, maintainable code while collaborating with cross-functional teams to deliver projects that meet both business goals and user needs. I thrive in environments that challenge me to continuously learn and grow.",
  ],
};
...
export const CONTACT_CONTENT = {
  ...
  email: "kdkrkrkrkiejer@example.com",
  socialLinks: [
    {
      platform: "Twitter",
  ...
  footerText: `© ${new Date().getFullYear()} Mohamed Taher. All rights reserved.`,
};
