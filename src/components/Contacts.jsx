...
const Contacts = () => {
  return (
    ...
    >
      ...
      <motion.p
        className="text-lg md:text-2xl leading-none mt-6 max-w-3xl"
        initial="hidden"
        whileInView={"visible"}
        custom={0.6}
        variants={textVariants}
      ...
      <motion.p initial="hidden" whileInView={"visible"} custom={1.6} variants={textVariants} className="text-sm text-stone-400 mt-36">
